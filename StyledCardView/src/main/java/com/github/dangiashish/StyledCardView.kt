package com.github.dangiashish
...
class StyledCardView: FrameLayout {
    companion object {
...
//    private var background_Gradient_Radius_Multiplier = DEFAULT_RADIUS_MULTIPLIER
    ...
    private fun initialize(context: Context, attrs: AttributeSet?) {
        attrs.let {
            val typedArray = context.obtainStyledAttributes(it, R.styleable.StyledCardView)
            // Get Background Style from XML
            background_Type = BackgroundType.values()[typedArray.getInteger(R.styleable.StyledCardView_background_Type, DEFAULT_BACKGROUND_TYPE.ordinal)]
            background_ColorType = ColorType.values()[typedArray.getInteger(R.styleable.StyledCardView_background_ColorType, DEFAULT_BACKGROUND_COLOR_TYPE.ordinal)]
            background_Color = typedArray.getColor(R.styleable.StyledCardView_background_Color, DEFAULT_COLOR_BACKGROUND)
            background_Alpha = floatPercentCheck(typedArray.getFloat(R.styleable.StyledCardView_background_Alpha, NOT_DEFINED_ALPHA))
            background_Gradient_Colors_Xml[0] = typedArray.getColor(R.styleable.StyledCardView_background_Gradient_Color0, NOT_DEFINED_COLOR)
            background_Gradient_Colors_Xml[1] = typedArray.getColor(R.styleable.StyledCardView_background_Gradient_Color1, NOT_DEFINED_COLOR)
            background_Gradient_Colors_Xml[2] = typedArray.getColor(R.styleable.StyledCardView_background_Gradient_Color2, NOT_DEFINED_COLOR)
            background_Gradient_Colors_Xml[3] = typedArray.getColor(R.styleable.StyledCardView_background_Gradient_Color3, NOT_DEFINED_COLOR)
            background_Gradient_Colors_Xml[4] = typedArray.getColor(R.styleable.StyledCardView_background_Gradient_Color4, NOT_DEFINED_COLOR)
            background_Gradient_Colors_Xml[5] = typedArray.getColor(R.styleable.StyledCardView_background_Gradient_Color5, NOT_DEFINED_COLOR)
            background_Gradient_Colors_Xml[6] = typedArray.getColor(R.styleable.StyledCardView_background_Gradient_Color6, NOT_DEFINED_COLOR)
            background_Gradient_Colors_Xml[7] = typedArray.getColor(R.styleable.StyledCardView_background_Gradient_ColorEnd, NOT_DEFINED_COLOR)
            background_Gradient_Angle = angleCheck(typedArray.getFloat(R.styleable.StyledCardView_background_Gradient_Angle, NOT_DEFINED_ANGLE))
            background_Gradient_OffCenter_X = boundaryCheck(typedArray.getFloat(R.styleable.StyledCardView_background_Gradient_OffCenter_X, DEFAULT_OFFCENTER_X), 1f)
            background_Gradient_OffCenter_Y = boundaryCheck(typedArray.getFloat(R.styleable.StyledCardView_background_Gradient_OffCenter_Y, DEFAULT_OFFCENTER_Y), 1f)
//            background_Gradient_Radius = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_background_Gradient_Radius, NOT_DEFINED_RADIUS))
//            background_Gradient_Radius_Multiplier = floatPercentCheck(typedArray.getFloat(R.styleable.StyledCardView_background_Gradient_Radius_Multiplier, DEFAULT_RADIUS_MULTIPLIER))
            // Get Stroke Style from XML
            stroke_Type = StrokeType.values()[typedArray.getInteger(R.styleable.StyledCardView_stroke_Type, DEFAULT_STROKE_TYPE.ordinal)]
            stroke_ColorType = ColorType.values()[typedArray.getInteger(R.styleable.StyledCardView_stroke_ColorType, DEFAULT_STROKE_COLOR_TYPE.ordinal)]
            stroke_Color = typedArray.getColor(R.styleable.StyledCardView_stroke_Color, DEFAULT_COLOR_STROKE)
            stroke_Alpha = floatPercentCheck(typedArray.getFloat(R.styleable.StyledCardView_stroke_Alpha, NOT_DEFINED_ALPHA))
            stroke_Width = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_stroke_Width, DEFAULT_STROKE_SIZE), null)
            stroke_Gradient_Colors_Xml[0] = typedArray.getColor(R.styleable.StyledCardView_stroke_Gradient_Color0, NOT_DEFINED_COLOR)
            stroke_Gradient_Colors_Xml[1] = typedArray.getColor(R.styleable.StyledCardView_stroke_Gradient_Color1, NOT_DEFINED_COLOR)
            stroke_Gradient_Colors_Xml[2] = typedArray.getColor(R.styleable.StyledCardView_stroke_Gradient_Color2, NOT_DEFINED_COLOR)
            stroke_Gradient_Colors_Xml[3] = typedArray.getColor(R.styleable.StyledCardView_stroke_Gradient_Color3, NOT_DEFINED_COLOR)
            stroke_Gradient_Colors_Xml[4] = typedArray.getColor(R.styleable.StyledCardView_stroke_Gradient_Color4, NOT_DEFINED_COLOR)
            stroke_Gradient_Colors_Xml[5] = typedArray.getColor(R.styleable.StyledCardView_stroke_Gradient_Color5, NOT_DEFINED_COLOR)
            stroke_Gradient_Colors_Xml[6] = typedArray.getColor(R.styleable.StyledCardView_stroke_Gradient_Color6, NOT_DEFINED_COLOR)
            stroke_Gradient_Colors_Xml[7] = typedArray.getColor(R.styleable.StyledCardView_stroke_Gradient_ColorEnd, NOT_DEFINED_COLOR)
            stroke_Gradient_Angle = angleCheck(typedArray.getFloat(R.styleable.StyledCardView_stroke_Gradient_Angle, NOT_DEFINED_ANGLE))
            stroke_Gradient_OffCenter_X = boundaryCheck(typedArray.getFloat(R.styleable.StyledCardView_stroke_Gradient_OffCenter_X, DEFAULT_OFFCENTER_X), 1f)
            stroke_Gradient_OffCenter_Y = boundaryCheck(typedArray.getFloat(R.styleable.StyledCardView_stroke_Gradient_OffCenter_Y, DEFAULT_OFFCENTER_Y), 1f)
            stroke_DashSize = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_stroke_DashSize, DEFAULT_STROKE_DASH_SIZE), null)
            stroke_GapSize = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_stroke_GapSize, DEFAULT_STROKE_GAP_SIZE), null)
            stroke_CapType = CapType.values()[(typedArray.getInteger(R.styleable.StyledCardView_stroke_CapType, DEFAULT_STROKE_CAP_TYPE.ordinal))]
            // Get Shadow Data from XML
            // Outer Shadow 1
            shadows[0].color = typedArray.getColor(R.styleable.StyledCardView_shadow0_Outer_Color, DEFAULT_SHADOW_COLOR)
            shadows[0].alpha = floatPercentCheck(typedArray.getFloat(R.styleable.StyledCardView_shadow0_Outer_Alpha, NOT_DEFINED_ALPHA))
            shadows[0].distance = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow0_Outer_Distance, NOT_DEFINED_DIMEN), NOT_DEFINED_DIMEN)
            shadows[0].blur = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow0_Outer_Blur, NOT_DEFINED_DIMEN), NOT_DEFINED_DIMEN)
            shadows[0].angle = angleCheck(typedArray.getFloat(R.styleable.StyledCardView_shadow0_Outer_Angle, NOT_DEFINED_ANGLE))
            // Outer Shadow 2
            shadows[1].color = typedArray.getColor(R.styleable.StyledCardView_shadow1_Outer_Color, DEFAULT_SHADOW_COLOR)
            shadows[1].alpha = floatPercentCheck(typedArray.getFloat(R.styleable.StyledCardView_shadow1_Outer_Alpha, NOT_DEFINED_ALPHA))
            shadows[1].distance = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow1_Outer_Distance, NOT_DEFINED_DIMEN), NOT_DEFINED_DIMEN)
            shadows[1].blur = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow1_Outer_Blur, NOT_DEFINED_DIMEN), NOT_DEFINED_DIMEN)
            shadows[1].angle = angleCheck(typedArray.getFloat(R.styleable.StyledCardView_shadow1_Outer_Angle, NOT_DEFINED_ANGLE))
            // Inner Shadow 1
            shadows[2].color = typedArray.getColor(R.styleable.StyledCardView_shadow0_Inner_Color, DEFAULT_SHADOW_COLOR)
            shadows[2].alpha = floatPercentCheck(typedArray.getFloat(R.styleable.StyledCardView_shadow0_Inner_Alpha, NOT_DEFINED_ALPHA))
            shadows[2].distance = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow0_Inner_Distance, NOT_DEFINED_DIMEN), NOT_DEFINED_DIMEN)
            shadows[2].blur = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow0_Inner_Blur, NOT_DEFINED_DIMEN), NOT_DEFINED_DIMEN)
            shadows[2].angle = angleCheck(typedArray.getFloat(R.styleable.StyledCardView_shadow0_Inner_Angle, NOT_DEFINED_ANGLE))
            // Inner Shadow 2
            shadows[3].color = typedArray.getColor(R.styleable.StyledCardView_shadow1_Inner_Color, DEFAULT_SHADOW_COLOR)
            shadows[3].alpha = floatPercentCheck(typedArray.getFloat(R.styleable.StyledCardView_shadow1_Inner_Alpha, NOT_DEFINED_ALPHA))
            shadows[3].distance = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow1_Inner_Distance, NOT_DEFINED_DIMEN), NOT_DEFINED_DIMEN)
            shadows[3].blur = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow1_Inner_Blur, NOT_DEFINED_DIMEN), NOT_DEFINED_DIMEN)
            shadows[3].angle = angleCheck(typedArray.getFloat(R.styleable.StyledCardView_shadow1_Inner_Angle, NOT_DEFINED_ANGLE))
            //
            shadow_Outer_Area = dimenCheck(typedArray.getDimension(R.styleable.StyledCardView_shadow_Outer_Area, NOT_DEFINED_SHADOW_OUTER_AREA), NOT_DEFINED_SHADOW_OUTER_AREA)
            //
            // Get Corner Radius from XML
            cornerRadius_ = typedArray.getDimension(R.styleable.StyledCardView_cornerRadius, NOT_DEFINED_CORNER_RADIUS)
            cornerRadius_TopLeft = typedArray.getDimension(R.styleable.StyledCardView_cornerRadius_TopLeft, NOT_DEFINED_CORNER_RADIUS)
            cornerRadius_TopRight = typedArray.getDimension(R.styleable.StyledCardView_cornerRadius_TopRight, NOT_DEFINED_CORNER_RADIUS)
            cornerRadius_BottomRight = typedArray.getDimension(R.styleable.StyledCardView_cornerRadius_BottomRight, NOT_DEFINED_CORNER_RADIUS)
            cornerRadius_BottomLeft = typedArray.getDimension(R.styleable.StyledCardView_cornerRadius_BottomLeft, NOT_DEFINED_CORNER_RADIUS)
            cornerType = CornerType.values()[typedArray.getInteger(R.styleable.StyledCardView_corner_Type, DEFAULT_CORNER_TYPE.ordinal)]
            typedArray.recycle()
        }
